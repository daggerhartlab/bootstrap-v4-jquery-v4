...
* Each test should follow the project's [JavaScript Code Guidelines](https://github.com/daggerhartlab/bootstrap-v4-jquery-v4/blob/v4-dev/.github/CONTRIBUTING.md#js)
