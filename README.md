...
- [Download the latest release.](https://github.com/daggerhartlab/bootstrap-v4-jquery-v4/archive/v4.7.0.zip)
- Clone the repo: `git clone https://github.com/daggerhartlab/bootstrap-v4-jquery-v4.git`
- Install with [npm](https://www.npmjs.com/): `npm install bootstrap`
- Install with [yarn](https://yarnpkg.com/): `yarn add bootstrap@4.7.0`
- Install with [Composer](https://getcomposer.org/): `composer require twbs/bootstrap:4.7.0`
